...
import kotlinx.android.synthetic.main.activity_return_old_bike.*
...
class ReturnOldBikeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_return_old_bike)
        ...
        fillRideQuiz.setOnClickListener {
            val intent = Intent(this@ReturnOldBikeActivity, RideQuizActivity::class.java)
